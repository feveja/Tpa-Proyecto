#Debido al tiempo no hemos podido realizar ciertas funciones como el calendario de organización y algunos resultados más exactos en algunas cosas como días de descanso, guías necesarios y poco más, espero que comprendan la situación al haber solo ha sido 2 personas en el equipo 10 gracias de antemano
import sys
import random
